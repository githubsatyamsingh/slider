...
$('.owl-carousel').owlCarousel({ loop: true, margin: 10, dots: true, nav: true, items: 1, mouseDrag: false, autoplay: true, autoplayTimeout: 5000, thumbs: true, thumbImage: true, thumbContainerClass: 'owl-thumbs', thumbItemClass: 'owl-thumb-item' });